...
const ROLE_GRANTS: Record<SystemRoleKey, [PermissionKey, DataScope][]> = {
  ...
  TEAM_MANAGER: [
    ...
    ['fulfillment.view', DataScope.DEPARTMENT],
    ['fulfillment.request', DataScope.DEPARTMENT],
    ['fulfillment.select_plan', DataScope.DEPARTMENT],
  ...
  TEAM_LEADER: [
    ...
    ['fulfillment.view', DataScope.MY_TEAM],
    ['fulfillment.request', DataScope.MY_TEAM],
    ['fulfillment.select_plan', DataScope.MY_TEAM],
  ...
  AGENT: [
    ...
    ['fulfillment.view', DataScope.MY_RECORDS],
    ['fulfillment.request', DataScope.MY_RECORDS],
